package com.binainsanlesatari.aksis.adapter;
...
import com.binainsanlesatari.aksis.ScreenItem;
...
public class IntroAdapter extends PagerAdapter {
    ...
    public IntroAdapter(Context context, List<ScreenItem> mListScreen) {
