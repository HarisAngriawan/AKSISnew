...
public class EditProfileSiswa extends AppCompatActivity {
        ...
        uploadprofil.getprofilsiswa(nisnSiswa).enqueue(new Callback<uploadimg>() {
            ...
            public void onResponse(Call<uploadimg> call, Response<uploadimg> response) {
                ...
                if (value == 1) {
                    ...
                    Picasso.with(EditProfileSiswa.this).load(BuildConfig.BASE_URL+imgpathprofil).fit().centerCrop()
                            .placeholder(R.drawable.student)
                            .error(R.drawable.student)
                            .into(fotoprofil);
                } else {
                    Toast.makeText(EditProfileSiswa.this, message, Toast.LENGTH_SHORT).show();
            ...
            if (requestCode == 1) {
                ...
                try {
                    ...
                    call.enqueue(new Callback<uploadimg>() {
                        ...
                        public void onFailure(Call<uploadimg> call, Throwable t) {
                            progress.dismiss();
                            Toast.makeText(EditProfileSiswa.this, "Gagal Upload !", Toast.LENGTH_SHORT).show();
                        }
                    });
        ...
        uploadprofil.updateprofil(imgpath, nisnSiswa)
                .enqueue(new Callback<InputPermohonan>() {
                    ...
                    public void onFailure(Call<com.binainsanlesatari.aksis.model.SiswaModel.InputPermohonan> call, Throwable t) {
                        progress.dismiss();
                        Toast.makeText(EditProfileSiswa.this, "Jaringan Error !", Toast.LENGTH_SHORT).show();
